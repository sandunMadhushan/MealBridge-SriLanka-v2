...
export default function Auth() {
  ...
  const [selectedRole, setSelectedRole] = useState<'donor' | 'recipient' | 'volunteer'>('donor');
  ...
  const roles = [
    {
      ...
      icon: '🍽️',
      benefits: ['List surplus food easily', 'Track your impact', 'Connect with community']
    },
    {
      ...
      icon: '🤝',
      benefits: ['Find food near you', 'Free & affordable options', 'Safe, quality assured']
    },
    {
      ...
      icon: '🚚',
      benefits: ['Make a difference', 'Earn recognition badges', 'Build connections']
    }
  ];
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        ...
        <h2 className="mt-6 text-center text-3xl font-bold text-gray-900">
          {isLogin ? 'Welcome back to MealBridge' : 'Join the MealBridge Community'}
        </h2>
        <p className="mt-2 text-center text-sm text-gray-600">
          {isLogin ? 'Sign in to continue making an impact' : 'Start your journey towards reducing food waste'}
        </p>
      </div>
