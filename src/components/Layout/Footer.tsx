        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="col-span-1 md:col-span-2">
            ...
            <p className="text-gray-300 mb-4 max-w-md">
              ...
              Together, we're building a sustainable future and stronger communities.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li><Link to="/find-food" className="text-gray-300 hover:text-white transition-colors">Find Food</Link></li>
              <li><Link to="/donate" className="text-gray-300 hover:text-white transition-colors">Donate Food</Link></li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li><Link to="/safety" className="text-gray-300 hover:text-white transition-colors">Food Safety</Link></li>
              <li><Link to="/guidelines" className="text-gray-300 hover:text-white transition-colors">Guidelines</Link></li>
        ...
        <div className="mt-8 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © 2024 MealBridge. All rights reserved. Built with ❤️ for Sri Lanka.
            </p>
