import { FoodListing, User, FoodCategory, ImpactStats, Story } from "../types";
      ...
      badges: [
        {
          id: "3",
          name: "Grateful Heart",
          description: "Received first donation",
          icon: "💚",
          earnedAt: new Date(),
        },
      ],
      ...
      badges: [
        {
          ...
          description: "Completed 30+ deliveries",
          icon: "🚚",
          earnedAt: new Date(),
        },
      ],
...
export const mockFoodListings: FoodListing[] = [
  {
    ...
    description:
      "Mixed vegetables including carrots, beans, and leafy greens. Perfect for a family meal.",
  ...
  },
  {
    ...
    description:
      "Fresh bread and pastries from our bakery. Baked this morning, perfect for evening consumption.",
  ...
  },
  {
    ...
    description:
      "Prepared rice and curry meals from our restaurant. Freshly cooked and properly stored.",
...
export const communityStories: Story[] = [
  {
    ...
    content:
      "When I lost my job during the pandemic, MealBridge became a lifeline for my family. The fresh vegetables and meals we received helped us get through the most difficult period...",
    author: mockUsers[1],
    images: [
  ...
  },
  {
    ...
    content:
      "As a restaurant owner, I was troubled by the amount of food we had to throw away daily. MealBridge gave us a purpose and helped us contribute to our community...",
    author: mockUsers[0],
    images: [
  ...
  },
  {
    ...
    content:
      "Being a delivery volunteer for MealBridge has been incredibly fulfilling. Every delivery is a chance to make someone's day better and reduce food waste...",
    author: mockUsers[2],
    images: [
